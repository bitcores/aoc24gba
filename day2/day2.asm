...
evalline:
	; r5 will hold if it is valid
	mov r5, #1
	; val of r7 == len-2 safe, 0-(len-2) safe
	mov r7, #0
...
goldcheck:
	...
	; set up size of subloop
	ldr r10, valarr
	ldrb r9, [r10]
	sub r11, r9, #1
	ldr r12, gvalarr
	strb r11, [r12]
	; r8 is the value we will skip each time we copy
	; the array
	mov r8, r9
checknextmyu:
	ldrb r9, [r10]
